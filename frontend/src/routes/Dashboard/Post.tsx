...
export default function Post({ firstLetter, name, time, message }: IPostProps) {
  return (
    <div className="bg-white rounded-xl p-4 shadow-sm flex flex-col gap-4">
      <div className="flex items-center gap-2 justify-between">
        ...
        <button className="hover:bg-gray-100 row-md border border-gray-50 rounded-full w-8 h-8 flex items-center justify-center">
          ...
        </button>
      </div>
      <p>{message}</p>
